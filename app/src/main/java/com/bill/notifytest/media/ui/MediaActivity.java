...
package com.bill.notifytest.media.ui;
...
import com.bill.notifytest.R;
import com.bill.notifytest.media.client.MediaBrowserManager;
import com.bill.notifytest.media.service.contentcatalogs.MusicLibrary;
...
public class MediaActivity extends AppCompatActivity {
    ...
    private void onMediaMetadataChanged(MediaMetadataCompat mediaMetadata) {
        ...
        // 音频的标题
        mTitleTv.setText(mediaMetadata.getString(MediaMetadataCompat.METADATA_KEY_TITLE));
        // 音频作者
        mArtistTv.setText(mediaMetadata.getString(MediaMetadataCompat.METADATA_KEY_ARTIST));
        // 音频图片
        mAlbumArtImg.setImageBitmap(MusicLibrary.getAlbumBitmap(MediaActivity.this,
