...
package com.bill.notifytest.media.service.player;
...
import com.bill.notifytest.media.service.PlaybackInfoListener;
 ...
 * so that {@link MediaActivity} can control music playback.
 */
public final class MediaPlayerManager extends PlayerAdapter {
     ...
     * created. In the onStop() method of the {@link MediaActivity} the {@link MediaPlayer} is
     * released. Then in the onStart() of the {@link MediaActivity} a new {@link MediaPlayer}
